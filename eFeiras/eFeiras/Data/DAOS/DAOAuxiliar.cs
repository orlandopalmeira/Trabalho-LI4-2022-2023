...
namespace eFeiras.Data.DAOS
{
    internal class DAOAuxiliar
    {
        ...
        internal static SubCategoria getSubCategoria(int subcategoriaID)
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(DAOconfig.GetConnectionString()))
                {
                    ...
                    aux.setCategoria(getCategoria(aux.getCategoriaID()));
                    result = aux;
                }
            }
            catch (Exception e) { throw new DAOException(e.Message); }
        ...
        internal static ICollection<SubCategoria> getSubCategorias()
        {
            ...
            try
            {
                using (SqlConnection con = new SqlConnection(DAOconfig.GetConnectionString()))
                {
                    ...
                    {
                        sc.setCategoria(getCategoria(sc.getCategoriaID()));
                        result.Add(sc);
                    }
                }
            }
        ...
        internal static bool existsEmail(string email)
        {
            bool result = false;
            string s_cmd = $"SELECT * FROM dbo.Utilizador where e_mail = '{email}'";
            try
            {
                using (SqlConnection con = new SqlConnection(DAOconfig.GetConnectionString()))
                {
        ...
        internal static bool existsCC(string cc)
        {
            bool result = false;
            string s_cmd = $"SELECT * FROM dbo.Utilizador where cartao_cidadao = '{cc}'";
            try
            {
                using (SqlConnection con = new SqlConnection(DAOconfig.GetConnectionString()))
                {
        ...
        internal static bool existsNIF(string nif)
        {
            bool result = false;
        ...
        {
            bool result = false;
            string s_cmd = $"SELECT * FROM dbo.Utilizador where username = '{username}'";
            try
            {
                using (SqlConnection con = new SqlConnection(DAOconfig.GetConnectionString()))
                {
        ...
        internal static Utilizador getUtilizadorByEmail(string email)
        {
        ...
        internal static ICollection<Feira> getFeirasEmCurso()
        {
            ICollection<Feira> result = new HashSet<Feira>();
            string s_cmd = "SELECT * FROM dbo.Feira WHERE GETDATE() BETWEEN data_inicio AND data_fim;";
            try
            {
                using (SqlConnection con = new SqlConnection(DAOconfig.GetConnectionString()))
                {
