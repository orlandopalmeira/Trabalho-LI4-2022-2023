...
{
    internal class BancaDAO // Chave -> Pair<id_feira,id_vendedor>
    {
        ...
        {
            return containsKey(new Pair<int, int>(value.getFeiraId(), value.getVendedorId()));
        }
